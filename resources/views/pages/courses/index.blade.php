...
<div>
                ...
                @foreach ($courses['data'] as $course)
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
                        ...
                        <div class="flex flex-col space-y-2">
                            <button type="button" data-modal-toggle="edit-user-modal-course" data-id="{{ $course['id'] }}" data-alias="{{ $course['alias'] }}" data-level="{{ $course['level'] }}" data-section="{{ $course['section'] }}" data-subject="{{ $course['subject'] }}" data-payment_rate="{{ $course['payment_rate'] }}" data-teaching_rate="{{ $course['teaching_rate'] }}" class="inline-flex items-center justify-center px-3 py-2 text-sm font-medium text-white rounded-lg bg-amber-400 hover:bg-amber-500 focus:ring-4 focus:ring-amber-300 dark:bg-amber-500 dark:hover:bg-amber-600 dark:focus:ring-amber-700">
                                <svg class="w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">    
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center space-x-2">
                                            <button type="button" data-modal-toggle="edit-user-modal-course" data-id="{{ $course['id'] }}" data-alias="{{ $course['alias'] }}" data-level="{{ $course['level'] }}" data-section="{{ $course['section'] }}" data-subject="{{ $course['subject'] }}" data-payment_rate="{{ $course['payment_rate'] }}" data-teaching_rate="{{ $course['teaching_rate'] }}" class="inline-flex items-center px-3 py-1.5 text-xs font-medium text-white rounded-md bg-amber-400 hover:bg-amber-500 focus:ring-4 focus:ring-amber-300 dark:bg-amber-500 dark:hover:bg-amber-600 dark:focus:ring-amber-700">
   ...
   class="inline-flex items-center px-3 py-1.5 text-xs font-medium text-white bg-red-600 rounded-md hover:bg-red-700 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900">
    <svg class="w-4 h-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="relative w-full h-full max-w-2xl px-4 md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Edit Kursus</h3>
                ...
                <form method="POST" onsubmit="return confirm('Apakah anda yakin untuk mengubah detail kursus?');">
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div class="sm:col-span-2">
                                <label for="teaching_rate" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Upah Mengajar</label>
                                <input type="number" min="0" name="teaching_rate" id="teaching_rate" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Masukan upah mengajar" required>
                            </div>
                        </div>
                    </div>
                ...
                <form action="/courses" method="POST" onsubmit="return confirm('Apakah anda yakin untuk menambah kursus?');">
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                          ...
                          <div>
    <label for="section_add" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
        Section
    </label>
    <select name="section" id="section_add" 
        ...
        <option value="F">F</option>
                            ...
                            <div class="sm:col-span-2">
                                <label for="school" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Harga Kelas</label>
                                <input type="number" min="0" name="payment_rate" id="school" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Masukkan harga kelas" required>
                            </div>
                            <div class="sm:col-span-2">
                                <label for="school" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Upah Mengajar</label>
                                <input type="number" min="0" name="teaching_rate" id="school" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Masukkan upah mengajar" required>
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col sm:flex-row items-center p-6 space-y-2 sm:space-y-0 sm:space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            editButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    modal.querySelector('#teaching_rate').value = this.getAttribute('data-teaching_rate') || '';
                });
            });
        });
    </script>
