...
<aside id="sidebar"
    ...
    aria-label="Sidebar">
    <div
        class="relative flex flex-col flex-1 min-h-screen lg:min-h-0 pt-0 bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                ...
                <ul class="py-2 space-y-2">
                    ...
                    <li>
                        ...
                        <ul id="dropdown-crud-students" class="space-y-2 py-2 ">
                            <li>
                                <a href="/students"
                                    class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 {{ $activeRoute == 'students' ? 'bg-gray-100 dark:bg-gray-700' : '' }} ">Data
                                    Siswa</a>
                            </li>
                            <li>
                                <a href="/getUnpaidStudents"
                                    class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 {{ $activeRoute == 'getUnpaidStudents' ? 'bg-gray-100 dark:bg-gray-700' : '' }} ">Tidak Bayar 2 Bulan</a>
                            </li>
                    ...
                    <li>
                        <button type="button"
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Penjadwalan</span>
                            <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                        ...
                        <ul id="dropdown-crud-students" class="space-y-2 py-2 ">
                            <li>
                                <a href="{{ route('schedule.generate.form') }}"
                            ...
                            <li>
                                <a href="{{ route('schedule.all-schedule') }}"
                                    class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 {{ $activeRoute == 'students' ? 'bg-gray-100 dark:bg-gray-700' : '' }} ">
                                    Cek Semua Jadwal </a>
                            </li>
