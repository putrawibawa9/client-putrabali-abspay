                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 mt-8 items-end">
                    <div>
                        ...
                        <div
                            ...
                            <h5 class="text-4xl font-bold tracking-tight text-gray-900 dark:text-white">15 Siswa</h5>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 mt-8 items-end">
                    <div>
                        ...
                        <div
                            ...
                            <p class="font-semibold text-xl text-gray-900 dark:text-white mb-6">Total :</p>
                            <h5 class="text-4xl font-bold tracking-tight text-gray-900 dark:text-white">15 Guru</h5>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div
                            ...
                            <p class="font-semibold text-xl text-gray-900 dark:text-white mb-6">Total :</p>
                            <h5 class="text-4xl font-bold tracking-tight text-gray-900 dark:text-white">15 Kelas</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 mt-8 items-end">
                    ...
                    <div>
                        ...
                        <div
                            ...
                            <p class="font-semibold text-xl text-gray-900 dark:text-white mb-6">Total :</p>
                            <h5 class="text-4xl font-bold tracking-tight text-gray-900 dark:text-white">15 Pertemuan</h5>
                        </div>
                    </div>
                </div>
            </div>
